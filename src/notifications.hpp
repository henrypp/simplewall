...
bool _app_notifycommand (HWND hwnd, UINT button_id, size_t timer_idx);
...
size_t _app_notifyget_id (HWND hwnd);
...
void _app_notifyshow (HWND hwnd, bool is_forced, bool is_safety);
