...
DECLSPEC_SELECTANY R_FASTLOCK lock_apps;
DECLSPEC_SELECTANY R_FASTLOCK lock_rules;
DECLSPEC_SELECTANY R_FASTLOCK lock_apply;
DECLSPEC_SELECTANY R_FASTLOCK lock_checkbox;
DECLSPEC_SELECTANY R_FASTLOCK lock_logbusy;
DECLSPEC_SELECTANY R_FASTLOCK lock_logthread;
DECLSPEC_SELECTANY R_FASTLOCK lock_transaction;
