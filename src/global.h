...
DECLSPEC_SELECTANY R_QUEUED_LOCK lock_context = PR_QUEUED_LOCK_INIT;
...
DECLSPEC_SELECTANY R_QUEUED_LOCK lock_cache_dns = PR_QUEUED_LOCK_INIT;

DECLSPEC_SELECTANY R_WORKQUEUE file_queue = {0};
DECLSPEC_SELECTANY R_WORKQUEUE log_queue = {0};
DECLSPEC_SELECTANY R_WORKQUEUE resolve_log_queue = {0};
